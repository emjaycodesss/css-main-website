  ...
  return (
    <section id="what-is-css" className="relative z-10 overflow-visible bg-[#1a1d2e] pt-24 md:pt-32 pb-0">
      ...
      <div className="w-full max-w-[1440px] 2xl:max-w-[1680px] mx-auto px-4 md:px-8 2xl:px-12 relative z-10">
        <div className="relative z-20 text-center md:text-left" ref={headingRef}>
          <motion.div
            className="inline-flex items-center mb-2 md:mb-4 justify-center md:justify-start"
          ...
          <motion.h3
            className="section-headline uppercase text-white mb-6 md:mb-8 cursor-default"
          ...
          <motion.p
            className="font-[var(--font-sans)] text-lg md:text-xl leading-relaxed text-[#b8b4c9] cursor-default"
            initial={{ opacity: 0, y: 24 }}
            animate={isInView ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.6, ease: [0.25, 0.46, 0.45, 0.94], delay: 0.22 }}
          >
